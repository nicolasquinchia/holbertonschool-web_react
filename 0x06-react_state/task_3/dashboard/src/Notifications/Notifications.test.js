...
describe("Test Notifications Component", () => {
    ...
    it("Renders the first NotificationItem component porperly", () => {
        ...
        expect(myComp.find('NotificationItem').first().html()).toEqual(
            '<li data-notification-type=\"default\" class=\"default_1tsdo2i-o_O-respon_1l6nodk\">New course available</li>'
        );
    });
...
describe("Notifications component with list attr", () => {
    ...
    it("Renders correctly if you pass an empty array", () => {
        ...
        expect(wrapper.find('NotificationItem').html()).toEqual('<li data-notification-type=\"default\" class=\"default_1tsdo2i-o_O-respon_1l6nodk\">No new notification for now</li>');
    });
